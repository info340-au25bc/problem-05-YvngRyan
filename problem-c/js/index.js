...
let lostOpponents = lost.map(extractOpponent);
...
let avgScoreDifference = huskyGames2016.reduce((total, game) => {
  let uwScore;
  let oppScore;
...
console.log(`Average score difference: ${avgScoreDifference}`);
